...
function Seller({ currentUser, userDesc }) {
    ...
    if (userDesc?.role === ("admin" || "teacher" || "student")) {
        return (
            <Stack>
                <Header handlePageChange={handlePageChange} activePage={activePage} tabs={tabs} logo={"Seller"} />
                {pagesList()}
            </Stack>
        )
    }
