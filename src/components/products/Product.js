  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Stack id="product-price" alignItems="flex-start">
          ...
          <Stack id="product-sold" alignItems="flex-start">
            <Typography fontSize={12} fontWeight={300}>
              Produk terjual
            </Typography>
            <Typography fontSize={12} fontWeight="bold">
          ...
          <Stack id="product-rating" alignItems="flex-start">
            <Typography fontSize={12} fontWeight={300}>
              Rating produk
            </Typography>
            <Stack direction="row">
      ...
      <Stack
        id="product-description-small-devices"
        spacing={1}
        sx={{
          width: "100%",
          minHeight: "33.333%",
